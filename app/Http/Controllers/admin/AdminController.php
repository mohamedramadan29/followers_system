...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        return view('admin.dashboard',compact('publicsetting'));
    }
    ...
    public function update_admin_password(Request $request)
    {
        ...
        $admin_data = \App\Models\admin\admin::where('email', Auth::guard('admin')->user()->email)->first();
    ...
    {
        $admin_data = \App\Models\admin\admin::where('id', Auth::guard('admin')->user()->id)->first();
        $id = $admin_data['id'];
        if ($request->isMethod('post')) {
