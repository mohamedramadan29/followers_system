                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            <label for="name" class="form-label"> محتوي الخبر <span class="star"
                                                    style="color: red"> * </span>
                                            </label>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            <label for="image" class="form-label"> تعديل الصورة
                                            </label>
                                            <input type="file" id="image" class="form-control" name="image">
                                        </div>
                                        <img src="{{ asset('assets/uploads/News/'.$news['image']) }}" width="80" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
