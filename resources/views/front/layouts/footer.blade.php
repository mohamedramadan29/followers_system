            ...
            <div class="col-xl-2 col-sm-6 col-xs-6">
                <div class="footer-widget">
                    ...
                    <ul class="footer-lists">
                        ...
                        <li class="footer-lists__item"><a href="product-details.html" class="footer-lists__link"> الاقسام  </a></li>
                        <li class="footer-lists__item"><a href="profile.html" class="footer-lists__link">  الخدمات   </a>
                        </li>
                        <li class="footer-lists__item"><a href="cart.html" class="footer-lists__link"> شروط الاستخدام  </a>
                        </li>
                        <li class="footer-lists__item"><a href="dashboard.html" class="footer-lists__link">تواصل معنا </a>
                        </li>
                    </ul>
                </div>
            </div>
