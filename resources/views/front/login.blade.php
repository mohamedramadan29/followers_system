                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-12">
                            <div class="flx-between gap-1">
                                ...
                                <a href="#" class="forgot-password text-decoration-underline text-main text-poppins font-14"> نسيت كلمة المرور </a>
                            </div>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-sm-12 mb-0">
                            <div class="have-account">
                                <p class="text font-14">   ليس لديك حساب ؟ <a
                                        class="link text-main text-decoration-underline  fw-500" href="{{ route('login') }}">  انشـاء حساب جديد  </a>
                                </p>
                            </div>
                        </div>
                    </div>
