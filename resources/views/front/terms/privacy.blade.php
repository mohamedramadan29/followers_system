...
@section('title', ' سياسة الاستخدام والخصوصية ')
@section('content')
                    ...
                    <div class="col-lg-12">
                        <div class="breadcrumb-two-content text-center">
                            ...
                            <ul class="breadcrumb-list flx-align gap-2 mb-2 justify-content-center">
                                ...
                                <li class="breadcrumb-list__item font-14 text-body">
                                    <span class="breadcrumb-list__text"> سياسة الاستخدام والخصوصية </span>
                                </li>
                            </ul>

                            <h3 class="breadcrumb-two-content__title mb-0 text-capitalize"> سياسة الاستخدام والخصوصية </h3>
                        </div>
                    </div>
                </div>
            </div>
